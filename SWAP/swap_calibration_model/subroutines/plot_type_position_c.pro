pro plot_type_position_c, yin, xin, xdim, ydim, x_off, y_off, ymn, xmn, ymx, xmx, lg_sz, mid_sz, sm_sz, thk, rad, output_type, FILE,color_code
...
;________easy way to move plot on page just change xoff and yoff
        DEVICE,FILE=FILE,/INC,XSI=xin ,YSI=yin, XOFF=0.0, YOFF=0.0,$
          /helvetica, /color, /portrait, bits=24
        !P.FONT=0
      endif
return
end
