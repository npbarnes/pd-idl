...
;------------------------------------------------------------
  ...
  ;___________________________________________________
  ;_____Find the energy step index to look up the
  ;_____correct step in the 3-D array w(E/Es, theta, Es).
  ;_____See slide 7.
  ;___________________________________________________
  ...
  ;___________________________________________________
  ;_____w(E/Es, theta, Es) =s4.array; see slide 7
  ;___________________________________________________
  w=s4.arr
  ...
  w_int=interpol(w(*,ix,iee),er1, enew)
  if enew lt min(er1) and enew gt max(er1) then w_int=0.0d
  ;____res - combined instrument response functions in slide 4
  ;____     res=aeff*w*p
  res = p_phi*w_int*aeff 
  return, res
end
;------------------------------------------------------------
