...
f_read_coord_d,'coord.dat',x,y,z,dzc,dzg,nx,ny,nz
x = x(minx:maxx)
y = y(miny:maxy)
z = z(minz:maxz)
...
f_read_coord_d,'coord.dat',x,y,z,dzg,dzc,nnx,nny,nnz
...
case pln of
   ...
   'xy': begin
      ...
      arr2=congrid(arr1,200,200,nfrm)
      xinteranimate,set=[200,200,nfrm]
